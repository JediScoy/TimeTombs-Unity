...
- The party decides to set out tomorrow morning.
    ...
    +[Ω]
        ->S0StartMenu
    +[NEXT EPISODE: {S0EpisodeTwo}]
        ->S0Ep2
->DONE

=== S0Ep2 ===
{S0EpisodeTwo} #location: mine arrival
...
- You turn tail and literally run for your life.
    +[Ω]
        ->S0StartMenu
    +{S0Ep3 > 1} [{S0EpisodeThree}]
        ->S0Ep4
    +{S0Ep3 == 0} [NEXT EPISODE: {S0EpisodeThree}]
        ->S0Ep3    
->DONE
...
- What to do?
    +[Ω]
        ->S0StartMenu
    +{S0Ep1 > 0} [Walk down the tunnel NEXT EPISODE]
        ->S0Ep4
    +{S0Ep1 < 1} [Gather your thoughts before leaving the room]
        ->S0Ep1
->DONE
...
SEASON: 0."{Season0}" is a actually a prologue to our a class narrative "Time Tombs."
PURPOSE:
